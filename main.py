...
class WelcomeScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        enter_button = MDRectangleFlatButton(text='Get Started', pos_hint={'center_x': 0.5, 'center_y': 0.3}, on_release=self.on_getstarted_button_click)
    ...
    def populate_data(self):
        ...
        for row in rows:
            ...
            data = [
                ...
                "Amount receiver for capitation", row[7],
    ...
    def populate_data(self):
        ...
        for row in rows:
            ...
            data = [
                ...
                "The number of enrollees that were referred for cesarean section", row[8],
                ...
                "Number of enrollees that were treated for complicated respiratory tract infection (Under 5 years old)", row[13],
                "Number of enrollees that were treated for complicated respiratory tract infection (Above 5 years old)", row[14],
